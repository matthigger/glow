...
setup / teardown / status / clear_storage / clear_jobs / stage_hcp / pause /
resume -- the commands that manage the AWS resources (IAM, ECR, the Batch
compute-env / queue / job-definition, S3).
