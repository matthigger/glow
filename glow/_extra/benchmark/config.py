...
from .run import (run_ana, run_ana_time, run_inner_edge, run_perm_fwer,
                  run_perm_inner, run_prune, run_race_maxz, run_segment,
                  run_stat)
...
# offsets) and a modest crop / few seeds -- a correctness check, not a figure,
# so it need not run at paper scale.
