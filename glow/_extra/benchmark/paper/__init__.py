...
worker, which only needs .run_old to unpickle run_ana and has no HCP data
on the container. Import CACHE_BY_LABEL straight from .config where the
catalogue is actually needed.
"""
from .run_old import run_ana, run_mancova
