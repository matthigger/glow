...
Both rules turn the FWER-significant region set into a disjoint antichain
(no selected region an ancestor of another), differing only in how:
...
from ..graph import get_parent, SCGraph
