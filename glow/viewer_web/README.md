...
python -m glow.viewer_web.bake_demos
...
python -m glow.viewer_web.server
```
...
python -m glow.viewer_web.bake_demos          # pickles are baked into the image
