...
This is a Mullner NN-array reimplementation of sklearn's structured
ward_tree, so the dendrograms match exactly (same children array, same
distances to float64 precision).
"""
import numpy as np
import pytest
