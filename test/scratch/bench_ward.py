...
def main():
    print(f'{"shape":<15} {"n_vox":<8} {"F":<5} {"sklearn":<12} {"ours":<12} {"speedup":<10}')
    print('-' * 70)
    cases = [
        ((10, 10, 10), 8),
        ((15, 15, 15), 8),
    ...
    for shape, F in cases:
        n, t_sk, t_ours, sp = bench_one(shape, F)
        print(f'{str(shape):<15} {n:<8} {F:<5} {t_sk*1000:<12.1f} '
